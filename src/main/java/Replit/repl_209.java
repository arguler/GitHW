...
Step 1: Create a list of Map (e.g. List<Map<String,Object>>) called
dataList.
...
Step 9: Print the values of each Iteration same as shown below in
Output example.
Step 10: Calculate the Sum of subtotal. and store is in variable
called totalPurchase.
