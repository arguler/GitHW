...
Create below instance variables. (Choose proper datatype and
...
public class repl_144 {
    ...
    public static void main(String[] args) {
        repl_144_StoreProduct obj = new repl_144_StoreProduct();
        obj.StoreProduct("Eggs", 3, "Produce", true, 10);
        obj.display();

        repl_144_StoreProduct obj1 = new repl_144_StoreProduct();
        obj1.StoreProduct("Paper Towels", 2, 24);
        obj1.display();

        repl_144_StoreProduct obj2 = new repl_144_StoreProduct();
        obj2.StoreProduct("Paper Towels", 2);
        obj2.display();
    }
}
